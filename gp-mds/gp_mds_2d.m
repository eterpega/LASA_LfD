function vel = gp_mds_2d(original_dynamics, gp_handle, demonstrated_data, query_pos);


angle_est = feval(gp_handle, demonstrated_data(1:2,:)', demonstrated_data(3,:)', query_pos');
